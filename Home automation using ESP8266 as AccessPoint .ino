...
void handle_OnConnect() {
  ...
  LED3status = LOW;
  LED4status = LOW;
  Serial.println("D! Status: OFF | D2 Status: OFF | D3 Status: OFF | D4 Status: OFF");
...
String SendHTML(uint8_t led1stat,uint8_t led2stat,uint8_t led3stat,uint8_t led4stat){
  ...
  ptr +=".button-off {background-color: #ff4d4d;}\n";
  ptr +=".button-off:active {background-color: #ff6666;}\n";
  ptr +=".container { position: relative; } \n";
  ptr +=".containerbackground {  margin: 3rem;  position: absolute; top: 0; left: 0; bottom: 0; z-index: -1; transform: rotate(300deg); -webkit-transform: rotate(300deg);  color: #c6afaf; }\n ";
  ptr +="p {font-size: 14px;color: #888;margin-bottom: 10px;}\n";
  ptr +="</style>\n";
  ptr +="</head>\n";
  ptr +="<body>\n";
  ptr += "<div class=\"container\">";
  ptr += "<div class=\"containerbackground\">  THOHT </div> ";
  ptr +="<h1>Embedded and IoT Applied Lab AP</h1>\n";
  ptr +="<h3>-By THOHT solutions.IoT</h3>\n";
  
   if(led1stat)
  {ptr +="<p>TubeLight 1 Status: ON</p><a class=\"button button-off\" href=\"/led1off\">OFF</a>\n";}
  else
  {ptr +="<p>TubeLight 1 Status: OFF</p><a class=\"button button-on\" href=\"/led1on\">ON</a>\n";}

  if(led2stat)
  {ptr +="<p>TubeLight 2 Status: ON</p><a class=\"button button-off\" href=\"/led2off\">OFF</a>\n";}
  else
  {ptr +="<p>TubeLight 2 Status: OFF</p><a class=\"button button-on\" href=\"/led2on\">ON</a>\n";}

  if(led3stat)
  {ptr +="<p>Fan 1 Status: ON</p><a class=\"button button-off\" href=\"/led3off\">OFF</a>\n";}
  else
  {ptr +="<p>Fan 1 Status: OFF</p><a class=\"button button-on\" href=\"/led3on\">ON</a>\n";}
  
  if(led4stat)
  {ptr +="<p>Fan 2 Status: ON</p><a class=\"button button-off\" href=\"/led4off\">OFF</a>\n";}
  else
  {ptr +="<p>Fan 2 Status: OFF</p><a class=\"button button-on\" href=\"/led4on\">ON</a>\n";}
